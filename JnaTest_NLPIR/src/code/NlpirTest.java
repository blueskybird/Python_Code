...
//		String argu = "D:\\NLPIR";//指定Data文件夹所在路径，因为要用到data文件夹下的Configure.xml文件，否则回报错：初始化失败！fail reason is Cannot Open Configure file D:\NLPIR\Data\Configure.xml
		String argu = "./";
...
//			nativeByte = CLibrary.Instance.NLPIR_GetFileKeyWords("D:\\NLPIR\\feedback\\huawei\\5341\\5341\\产经广场\\2012\\5\\16766.txt", 10,false);
			nativeByte = CLibrary.Instance.NLPIR_GetFileKeyWords("./18届三中全会.TXT", 10,false);
